...
class HookRunEconomy(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    artifact_refs: Annotated[list[str] | None, Field(alias="artifactRefs")] = None
    bypass_reason: Annotated[str | None, Field(alias="bypassReason")] = None
    command_class: Annotated[str | None, Field(alias="commandClass")] = None
    decision_type: Annotated[str | None, Field(alias="decisionType")] = None
    estimated_saved_tokens: Annotated[
        int | None, Field(alias="estimatedSavedTokens")
    ] = None
    exact_output_reason: Annotated[str | None, Field(alias="exactOutputReason")] = None
    model_visible_bytes: Annotated[
        int | None, Field(alias="modelVisibleBytes", ge=0)
    ] = None
    original_bytes: Annotated[int | None, Field(alias="originalBytes", ge=0)] = None
    original_token_count: Annotated[
        int | None, Field(alias="originalTokenCount", ge=0)
    ] = None
    output_model_visible_bytes: Annotated[
        int | None, Field(alias="outputModelVisibleBytes", ge=0)
    ] = None
    output_original_bytes: Annotated[
        int | None, Field(alias="outputOriginalBytes", ge=0)
    ] = None
    replacement_bytes: Annotated[int | None, Field(alias="replacementBytes", ge=0)] = (
        None
    )
    token_budget: Annotated[int | None, Field(alias="tokenBudget", ge=0)] = None
...
class HookRunSummary(BaseModel):
    ...
    economy: HookRunEconomy | None = None
    ...
    status_message: Annotated[str | None, Field(alias="statusMessage")] = None
    trust_status: Annotated[HookTrustStatus | None, Field(alias="trustStatus")] = None
...
class PluginShareContext(BaseModel):
    ...
    remote_plugin_id: Annotated[str, Field(alias="remotePluginId")]
    share_targets: Annotated[
        list[PluginSharePrincipal] | None, Field(alias="shareTargets")
    ] = None
