...
impl ModelProvider for ConfiguredModelProvider {
    ...
    fn models_manager(
        ...
        match config_model_catalog {
            ...
            None if self.info.wire_api == WireApi::DeepSeekChat => Arc::new(
                StaticModelsManager::new(self.auth_manager.clone(), deepseek_chat_model_catalog()),
            ),
            None => {
...
fn deepseek_chat_model_catalog() -> ModelsResponse {
    ModelsResponse {
        models: vec![
            model_info_from_slug("deepseek-v4-flash"),
            model_info_from_slug("deepseek-v4-pro"),
        ],
    }
}
...
mod tests {
    ...
    #[tokio::test]
    async fn deepseek_chat_provider_creates_static_models_manager() {
        let provider = create_model_provider(
            ModelProviderInfo {
        ...
        assert_eq!(model_ids, vec!["deepseek-v4-flash", "deepseek-v4-pro"]);
    }
