...
fn model_provider_from_proto(
    ...
    let wire_api = match proto::WireApi::try_from(provider.wire_api) {
        ...
        Ok(proto::WireApi::DeepseekChat) => WireApi::DeepSeekChat,
...
fn proto_wire_api(wire_api: WireApi) -> proto::WireApi {
    match wire_api {
        ...
        WireApi::DeepSeekChat => proto::WireApi::DeepseekChat,
    }
}
...
mod tests {
    ...
    #[test]
    fn model_provider_proto_roundtrips_deepseek_chat_wire_api() {
