...
///
/// Gateway-style clients can receive dense bursts of item, MCP, shell, and
/// token-usage events during long non-interactive turns. Keep the queue bounded,
/// but leave enough headroom that a brief client-side scheduling pause does not
/// look like a slow consumer and force a spurious transport disconnect.
